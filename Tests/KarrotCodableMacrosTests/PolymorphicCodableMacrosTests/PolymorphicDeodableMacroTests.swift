...
final class PolymorphicDecodableMacroTests: XCTestCase {

  #if canImport(KarrotCodableKitMacros)
  let testMacros: [String: Macro.Type] = [
    "PolymorphicDecodable": PolymorphicDecodableMacro.self,
  ]
  #endif

  func testPolymorphicDecodableMacro() throws {
    #if canImport(KarrotCodableKitMacros)
    assertMacroExpansion(
      ...
      expandedSource: """
        ...
        extension DismissibleCallout: PolymorphicDecodableType {
  ...
  func testPolymorphicDecodableMacroIdentifierValueError() {
    #if canImport(KarrotCodableKitMacros)
    assertMacroExpansion(
      """
      @PolymorphicDecodable(
