...
struct LossyArrayRecoveryPolicyTests {
  ...
  @Test func testOptionalLossyArrayRecoversEmptyArrayForNonArrayValue() throws {
    // given
    let jsonData = #"""
    {
  ...
  #if DEBUG
  @Test func testOptionalLossyArrayNonArrayValueOutcomeIsRecovered() throws {
    // given
    let jsonData = #"""
    {
      "notices1" : "not an array"
  ...
  @Test func testLossyArrayRecoversWhenDecodedDirectly() throws {
  ...
  @Test func testOptionalLossyArrayRecoversWhenDecodedDirectly() throws {
    // given
    let jsonData = #"""
    {
      "group" : "not an array"
  ...
  #if DEBUG
  @Test func testLossyArrayElementFailureIsRecordedInOutcome() throws {
  ...
  @Test func testOptionalLossyArrayElementFailureIsRecordedInOutcome() throws {
    // given
    let jsonData = #"""
    {
      "notices1" : [
