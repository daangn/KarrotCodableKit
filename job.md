일단 현재 패키지 코드들과 아래 링크를 gh 명령어를 사용해서 탐색해줘
https://github.com/airbnb/ResilientDecoding

현재 swift package에 존재하는 프로퍼티래퍼들에 ResilientDecoding 라이브러리에 있는 ResilientRawRepresentable 기능을 추가하고 싶어
...
그리고 나서 현재 패키지에 있는 코드들을 탐색해서 어떤 프로퍼티래퍼들이 존재하고 Resilient에 있는 기능들을 기존 프로퍼티래퍼들에 적용하려면 어떻게 해야할지 단계별로 계획을 작성해야해
...
- `Tests/KarrotCodableKitTests/PolymorphicCodable/[Wrapper]/[Wrapper]ResilientTests.swift`
